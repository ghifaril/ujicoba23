...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date("Jan 23, 2024 00:00:00").getTime(),
...
new TypeIt("#teks1", {
  strings: [
    ...
    " ",
    "Saya Ahmad Ghifaril Afkar pada hari ini Kamis, 23 Januari 2025 dengan sepenuh hati mengucapkan",
    " ",
    "<b>Selamat Ulang Tahun Yang ke - 16</b>",
    " ",
    "Kepada Saqila  Ananditha Kirana, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya",
    ,
    " ",
    "Wassalamualaikum Wr. Wb",
    " ",
    "- Faril Afkar, Mas ganteng :)",
  ],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [
    ...
    "Happy Birthday ya..",
    " ",
    "Ciie 16 tahun ni, meskipun belom legal tapi selamat ya wkwk. gak kerasa yaa kita udah bareng-bareng selama ini, semoga di umur yang sekarang kamu bisa jadi pribadi yang lebih baik lagi, lebih rajin, lebih sholehah, dan lebih berbakti.",
